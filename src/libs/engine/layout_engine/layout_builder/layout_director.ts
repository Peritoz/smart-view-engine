...
function extractToView(view: HydratedView, container: BaseElement | LayoutElementGroup) {
    const isNestedElement = container instanceof VisibleLayoutRow || container instanceof VisibleLayoutCol;
...
export class LayoutDirector {
    ...
    newRow(mainAxisAlignment: Alignment, crossAxisAlignment: Alignment, withoutMargin: boolean) {
        return this.layoutSet.newRow(mainAxisAlignment, crossAxisAlignment, withoutMargin);
    }

    newCol(mainAxisAlignment: Alignment, crossAxisAlignment: Alignment, withoutMargin: boolean) {
        return this.layoutSet.newCol(mainAxisAlignment, crossAxisAlignment, withoutMargin);
    }

    newVisibleRow(name: string, type: string, mainAxisAlignment: Alignment, crossAxisAlignment: Alignment, lateralLabel: boolean) {
        return this.layoutSet.newVisibleRow(name, type, mainAxisAlignment, crossAxisAlignment, lateralLabel);
    }

    newVisibleCol(name: string, type: string, mainAxisAlignment: Alignment, crossAxisAlignment: Alignment, lateralLabel: boolean) {
        return this.layoutSet.newVisibleCol(name, type, mainAxisAlignment, crossAxisAlignment, lateralLabel);
    }
