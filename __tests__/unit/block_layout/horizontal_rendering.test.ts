...
describe('Horizontal Rendering', () => {
    it('Horizontal - Main Axis - Start Alignment', async () => {
        ...
        group.addContainer(elementBuilder.buildElement({name: "A", width: 50, height: 25, x: 0, y: 0}));
        group.addContainer(elementBuilder.buildElement({name: "B", width: 100, height: 50, x: 0, y: 0}));
        group.addContainer(elementBuilder.buildElement({name: "C", width: 150, height: 60, x: 0, y: 0}));
    ...
    it('Horizontal - Main Axis - Center Alignment', async () => {
        ...
        group.addContainer(elementBuilder.buildElement({name: "C", width: 50, height: 60, x: 0, y: 0}));
    ...
    it('Horizontal - Row Resizing - After Insert Cols', async () => {
        ...
        col1.addContainer(elementBuilder.buildElement({name: "A", width: 50, height: 25, x: 0, y: 0}));
        col1.addContainer(elementBuilder.buildElement({name: "B", width: 60, height: 50, x: 0, y: 0}));
        col2.addContainer(elementBuilder.buildElement({name: "C", width: 25, height: 60, x: 0, y: 0}));
    ...
    it('Horizontal - Insertion Resize (Global Distribution)', async () => {
        ...
        const el1 = elementBuilder.buildElement({name: "A", width: 50, height: 30, x: 0, y: 0});
        const el2 = elementBuilder.buildElement({name: "B", width: 75, height: 35, x: 0, y: 0});
        ...
        const el3 = elementBuilder.buildElement({name: "A", width: 60, height: 50, x: 0, y: 0});
        ...
        const el4 = elementBuilder.buildElement({name: "A", width: 100, height: 60, x: 0, y: 0});
